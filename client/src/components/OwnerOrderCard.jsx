          ...
          <div key={shopOrder._id || shopIndex} className="space-y-3 sm:space-y-4">
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 bg-gradient-to-r from-gray-50 to-blue-50 rounded-lg px-3 sm:px-4 py-3 border border-gray-200">
              <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
                ...
                {shopOrder?.status === 'out for delivery' && shopOrder?.assignedDeliveryBoy && (
                  <div className="flex items-center gap-2 bg-purple-50 border border-purple-200 rounded-lg px-3 py-1.5">
                    <div className="flex items-center gap-2">
                      <div className="flex h-6 w-6 items-center justify-center rounded-full bg-purple-100 text-purple-700 text-xs font-medium">
                        {shopOrder.assignedDeliveryBoy.fullName?.charAt(0)?.toUpperCase() || 'D'}
                      </div>
                    ...
                    <div className="flex items-center gap-1 text-gray-600">
                      <MdPhone className="text-purple-500" size={14} />
